...
module.exports = {
  install() {
    ...
    console.log(chalk.yellow.bold(`\nPlease make sure you are running me in the parent directory where you keep all of your local site code (ex: Sites). Currently you\'re in ${chalk.inverse(files.getCurrentDirectoryBase())}. If this is where you want to install your WordPress directory, great! Continue. Otherwise, move to that directory and restart me. Thanks.`));
